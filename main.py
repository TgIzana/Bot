...
ADMIN_USER_ID = '6077960309'
ADMIN_USERNAME = 'TZ_IZANA'
BOT_TOKEN = '7503515632:AAGPbZxPzSQfk7690iIh42CccdpFnGRdX0k'
DEFAULT_DOMAIN = 'indxdark.com'
available_domains = [DEFAULT_DOMAIN]
user_subdomains = {}
cloudflare_configs = {
    'indxdark.com': {
        'api_key': 'fdde25e369f19011c622c71496f7c03db7a50',
        'zone_id': '6f420d92ef5eed89ea1acf47f5923436',
        'email': 'kp7846581@gmail.com'
    }
}
(ASK_API_KEY, ASK_ZONE_ID, ASK_EMAIL, ASK_DOMAIN, ASK_IP) = range(5)
 
RESERVED_DOMAINS = ['indxdark.com']  # Add your reserved domains here
PRIVATE_IP_RANGES = [
...
def generate_random_subdomain(domain):
    ...
    return f"{random_text}.izana.{domain}"
